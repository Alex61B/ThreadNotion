...
export declare const DrillPlanStoredSchema: z.ZodObject<{
    mode: z.ZodLiteral<"drill">;
    primarySkill: z.ZodEnum<{
    ...
    drillObjective: z.ZodString;
    promptPlan: z.ZodObject<{
...
export declare function parseDrillPlanStored(json: unknown): DrillPlanStored;
export declare function safeParseDrillPlanStored(json: unknown): z.ZodSafeParseResult<{
    mode: "drill";
    primarySkill: "discovery_questions" | "objection_handling" | "product_knowledge" | "closing" | "storytelling" | "empathy";
    variantKey: string;
    ...
    secondarySkill?: "discovery_questions" | "objection_handling" | "product_knowledge" | "closing" | "storytelling" | "empathy" | undefined;
}>;
//# sourceMappingURL=drillPlan.d.ts.map