...
exports.enrichAdaptiveScenarioPlanWithRealism = enrichAdaptiveScenarioPlanWithRealism;
const deriveFromSeed_1 = require("./deriveFromSeed");
function realismLines(plan) {
 ...
 */
function enrichAdaptiveScenarioPlanWithRealism(plan, seed, personaName) {
    const realism = (0, deriveFromSeed_1.deriveSimulationRealism)(seed, personaName);
    const next = {
        ...plan,
...
//# sourceMappingURL=enrichPlan.js.map